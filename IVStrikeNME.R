...
SOFRSpot_Smile_MixedExp <- function(S, t, T, jumps, jumps_, thetat, xit, rt, st, intS_t){
...
### Strike
K_Smile_MixedExp <- 100 * (1 - SOFRSpot_Smile_MixedExp(S = S, t = 0, T = T, jumps = jumps, jumps_ = jumps_, thetat = theta0, xit = xi0, rt = r0, st = s0, intS_t = 0))
k_Smile_MixedExp <- (T - S) * (100 - K_Smile_MixedExp) / 100
...
q_hat_Smile_MixedExp <- function(w, S, t, T, jumps, jumps_, K, ZCB, thetat, xit, rt, st, intS_t){ 
...
####################################################################################################################
####################################################################################################################
price1MSOFROption_Smile_MixedExp <- function(S, t, T, jumps, jumps_, K, ZCB, thetat, xit, rt, st, intS_t) { 
  umax <- 50000
  integrand_q_hat <- function(w) {
    Re(q_hat_Smile_MixedExp(w, S = S, t = t, T = T, jumps = jumps, jumps_ = jumps_, K = K, ZCB = ZCB, thetat = thetat, xit = xit, rt = rt, st = st, intS_t = intS_t) / 
...
CallSmile_MixedExp <- rep(NA, length(StrikeSmile))
IVSmile_MixedExp <- rep(NA, length(StrikeSmile))
for (i in 1:length(StrikeSmile)) {
  print(i)
  CallSmile_MixedExp[i] <- price1MSOFROption_Smile_MixedExp(S = S, t = 0, T = T, jumps = jumps, jumps_ = jumps_,
                                                            K = StrikeSmile[i], ZCB = ZCB_s_NME(t = 0, T = T, thetat = theta0, xit = xi0, rt = r0, st = s0),
                                                            thetat = theta0, xit = xi0, rt = r0, st = s0, intS_t = 0)
  IVSmile_MixedExp[i] = IVTest(spot = K_Smile_MixedExp, strike = StrikeSmile[i], t = 0, T = T,
                               ZCB_s_NME(t = 0, T = T, thetat = theta0, xit = xi0, rt = r0, st = s0), CallSmile_MixedExp[i])
}
